...
class leadsurf_lite_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        $this->opts = array(
            'before' => '&nbsp;',
            'after' => '&nbsp;',
            'delimiter' => '<span class="leadsurf-breadcrumbs-separator"> / </span>'
        );
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'leadsurf-lite') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'leadsurf-lite') . ' : ' . $curauth->display_name;
        }

        if (is_tag()) {
            return __('Tag', 'leadsurf-lite') . ' : ' . single_tag_title('', false);
        }

        if (is_search()) {
            return __('Search', 'leadsurf-lite');
        }

		if (is_404()) { return __('Error 404', 'leadsurf-lite');  }
...
$leadsurf_lite_breadcumb = new leadsurf_lite_breadcrumb_class();
