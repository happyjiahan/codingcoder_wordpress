...
?>
	...
	?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header hero">
					...
					<div class="entry-meta">
						...
						<?php edit_post_link( __( 'Edit', 'pblog' ), '<span class="edit-link">', '</span>' ); ?>
					</div><!-- .entry-meta -->
				</header><!-- .entry-header -->
			...
			<nav id="image-navigation" class="navigation image-navigation width620">
				<div class="nav-links">
				<?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'pblog' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'pblog' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
